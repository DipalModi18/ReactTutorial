...
class Section extends React.Component {
    ...
    handleScrollToElement(event) {
        const tesNode = ReactDOM.findDOMNode(this.refs.circle);
    ...
    render = () => {
      return (
        <div>
          ...
          <Link to="mytest" spy={true} smooth={true} duration={500}>My Test</Link>

          <button activeClass="active" className="btn" type="submit" value="Test 2" to="test2" spy={true} smooth={true} offset={50} duration={500} >
            Test 2
          </button>

          <button onClick={this.handleScrollToElement}>Scroll to Person</button>
